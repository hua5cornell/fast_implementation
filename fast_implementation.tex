...
\path [line, very thick] ([yshift=0.35cm]1.east) -- ([yshift=0.34cm]2.west);
\path [line, very thick] ([yshift=0.35cm]2.east) -- ([yshift=0.34cm]3.west);
\path [line, very thick] ([yshift=0.35cm]3.east) -- ([yshift=0.34cm]4.west);
\path [line, very thick] ([yshift=0.35cm]4.east) -- ([yshift=0.34cm]5.west);
\path [line, very thick] (d.east) -- ([yshift=0.34cm]1.west);
...
\node [cycle] (13) [right = -0.25cm of 10] {};
